...
import { setPage, setPageSize, getUserBids } from '../../../../redux-store/slices/auctionBids'
...
const Index = () => {
  ...
  const { userBids, page, pageSize, total, initialLoading, loading } = useSelector(state => state.auctionBids)

  useEffect(() => {
    dispatch(getUserBids({ userId, page, pageSize }))
                  ...
                  <div className='flex-1 space-y-4'>
                    ...
                    <div className='flex flex-wrap gap-4 text-sm text-muted-foreground'>
                      <div className='flex items-center gap-2'>
                        <i className='tabler-calendar' /> Created Time :<span>{formatDate(bid.createdAt)}</span>
                      </div>
                      <div className='flex items-center gap-2'>
